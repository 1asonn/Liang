...
const SET_SHOW_THEME_SETTING = 'SET_SHOW_THEME_SETTING';
  ...
  actions: {
    async [SET_LANG](lang: Locale) {
      loadLanguageAsync(lang)
        .then(() => {
          this.lang = lang;
          sessionStorage.set(STORAGE_LANG_KEY, lang);
        })
        .catch(() => {});
    },
    ...
    [SET_SHOW_THEME_SETTING](is: boolean) {
      this.showThemeSetting = is;
    },
  },
  getters: {},
});
...
if (hot) {
  hot.accept(acceptHMRUpdate(useAppStore as any, hot));
}
