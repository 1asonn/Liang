...
import defaultLangValue from './lang-config/zh-CN';
export const defaultLang = 'zh-CN';
export const locales = ['zh-CN', 'zh-TW', 'en', 'Malay'];
export type Locale = 'zh-CN' | 'zh-TW' | 'en' | 'Malay';
...
window['setLang'] = loadLanguageAsync;
export default i18n;
